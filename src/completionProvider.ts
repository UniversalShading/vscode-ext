...
export class USLCompletionItemProvider implements vscode.CompletionItemProvider {
    ...
    private getShaderFunctions(): vscode.CompletionItem[] {
    ...
    private getBuiltInTypes(): vscode.CompletionItem[] {
        const types = [
    ...
    private getStorageModifiers(): vscode.CompletionItem[] {
        const modifiers = [
    ...
    private getBuiltInFunctions(): vscode.CompletionItem[] {
        const functions = [
    ...
    private getTextureFunctions(): vscode.CompletionItem[] {
        const functions = [
    ...
    private getMathFunctions(): vscode.CompletionItem[] {
        const functions = [
